...
// Data Description
#define ADNS_BURST_READ_MAX_BYTES 14
// Default Communication Settings (exclusive)
#define ADNS_DEFAULT_CHIP_SELECT_PIN 4
#define ADNS_DEFAULT_MOTION_SENSE_PIN 0
...
enum class RegisterAddress : byte
{
